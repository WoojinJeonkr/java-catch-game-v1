...
public class Monster9 extends MonsterBase {
	...
	public boolean catchMonster() {
		...
		this.e = r.nextInt(3);
		if (e == 0) {
			System.err.println("\"98.8% 확률로 펄기아는 포켓볼을 가볍게 피하며 속삭인다.\"\n" +
					"➤ \"조상님이 안 도와주시나보다 제사를 잘 지내보도록 하자!\"\n" +
					"(그녀의 몸은 공간의 균열 속으로 사라졌다. 잔향만이 남았다.)");
		} else if (e == 1) {
			System.err.println("\"98.8% 확률로 포켓볼이 공중에서 멈췄다… 펄기아가 시간을 굽히고 있다.\"\n" +
					"➤ \"…잡히는 게 무서운 게 아니라… 네가 날 진심으로 부르지 않아서야.\"\n" +
					"(볼은 조용히 떨어지고, 그녀의 눈빛은 아련하다.)");
		} else {
			System.err.println("\"98.8% 확률로 펄기아는 포켓볼을 바라보며 슬쩍 미소 지었다.\"\n" +
